...
*/
function templateMailContent($hikingName, $hikingLevel, $hikingDuration, $hikingElevation, $hikingMeetingLocation, $hikingMeetingTime, $hikingMeetingGPS, $hikingOtherDetails, $hikingLink, $carSharingCost,  $organiserName, $organiserPhone) {
	...
	<p>I hope you are all well. If the forecast is good the <?php echo substr($hikingMeetingTime,0,10); ?>, I suggest you the hiking <?php echo $hikingName ?>. It's a <?php echo $hikingLevel ?> level hiking.</p>
	
	<p>Hiking details:<br/>
	Name : <?php echo $hikingName ?><br/>
	Duration : <?php echo $hikingDuration ?>H (more with stops)<br/>
	Elevation: +<?php echo $hikingElevation ?>m<br/>
	...
	<p>The meeting point is at <?php echo $hikingMeetingLocation ?><?php if($hikingMeetingGPS != "") {?> (GPS coordinates: <a href="https://www.google.fr/maps/place/<?php echo $hikingMeetingGPS ?>"><?php echo $hikingMeetingGPS ?></a>)<?php }?>. If you need a ride from Nice or somewhere else, please ask in the comment section.</p>
